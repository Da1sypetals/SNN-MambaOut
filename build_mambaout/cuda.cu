...
float c3 = a_c3[in][ik];
            ...
            res += ((c3 * ((c1 * (r1 + c2)) - 1.0f)) * expf((((((-0.5f) * c1) * c1) * (r1 + c2)) * (r1 + c2))));
        }
        a_result[im][in] = res;
    }
}
...
float c3 = a_c3[in][ik];
            ...
            grad_r1 += ((((c1 * c3) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))) + (((c3 * (-1.00000000000000f + (c1 * (c2 + r1)))) * ((((-0.500000000000000f * c1) * c1) * (c2 + r1)) + ((-0.500000000000000f * (c1 * c1)) * (c2 + r1)))) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))))) * gout;
...
float grad_c3 = 0.0f;
        ...
        for (int im = 0; im < M; im++)
        {
            ...
            grad_c1 += ((((c3 * (c2 + r1)) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))) + (((((-1.00000000000000f * c1) * c3) * ((c2 + r1) * (c2 + r1))) * (-1.00000000000000f + (c1 * (c2 + r1)))) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))))) * gout;
grad_c2 += ((((c1 * c3) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))) + (((c3 * (-1.00000000000000f + (c1 * (c2 + r1)))) * ((((-0.500000000000000f * c1) * c1) * (c2 + r1)) + ((-0.500000000000000f * (c1 * c1)) * (c2 + r1)))) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1)))))) * gout;
grad_c3 += (((-1.00000000000000f + (c1 * (c2 + r1))) * expf(((((-0.500000000000000f * c1) * c1) * (c2 + r1)) * (c2 + r1))))) * gout;
