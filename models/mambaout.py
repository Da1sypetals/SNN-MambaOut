...
def mambaout_femto(pretrained=False, **kwargs):
    model = MambaOut(depths=[3, 3, 9, 3], dims=[48, 96, 192, 288], **kwargs)
...
def mambaout_pico(pretrained=False, **kwargs):
    model = MambaOut(depths=[3, 3, 9, 3], dims=[24, 48, 96, 128], **kwargs)
...
def mambaout_tiny(pretrained=False, **kwargs):
    model = MambaOut(depths=[3, 3, 9, 3], dims=[96, 192, 384, 576], **kwargs)
...
def mambaout_small(pretrained=False, **kwargs):
    model = MambaOut(depths=[3, 4, 27, 3], dims=[96, 192, 384, 576], **kwargs)
...
def mambaout_base(pretrained=False, **kwargs):
    model = MambaOut(depths=[3, 4, 27, 3], dims=[128, 256, 512, 768], **kwargs)
